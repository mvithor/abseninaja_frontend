      ...
      <TableContainer>
        <Table>
          ...
          <TableBody>
            ...
            ) : (userSiswa?.length ?? 0) === 0 ? (
              <TableRow>
                <TableCell colSpan={5}>
                  <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: 100, textAlign: 'center' }}>
                    <Typography variant="h6">Tidak ada pengguna siswa ditemukan</Typography>
                  </Box>
                </TableCell>
              </TableRow>
            ) : (
              paged.map((siswaUser, index) => (
                <TableRow key={siswaUser.user_id ?? index}>
                  <TableCell>
                  ...
                  <TableCell align="center">
                    <Typography sx={{ fontSize: '1rem' }}>
                      {siswaUser.updated_at || 'Tidak Ada'}
                    </Typography>
                  </TableCell>
                  ...
                  <TableCell>
                    <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 1 }}>
                      <Tooltip title="Preferensi Notifikasi" placement="bottom">
                        <IconButton onClick={() => handleOpenPrefs?.(siswaUser.user_id)}>
                          <IconBell width={18} />
                        </IconButton>
                      </Tooltip>
