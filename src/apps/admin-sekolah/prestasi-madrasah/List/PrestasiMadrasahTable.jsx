                ...
                <Table>
                    ...
                    <TableBody>
                      {isLoading ? (
                        ...
                        visibleRows.map((prestasiMadrasah, index) => (
                            <TableRow key={prestasiMadrasah.id}>
                            <TableCell>
                            ...
                            <TableCell align="center">
                                <Typography sx={{ fontSize: '1rem' }}>
                                {prestasiMadrasah.nama_prestasi}
                                </Typography>
                            </TableCell>
                            <TableCell align="center">
                                <Typography sx={{ fontSize: '1rem' }}>
                                {formatKategori(
                                    prestasiMadrasah.kategori_sifat,
                                    prestasiMadrasah.kategori_bidang
                                )}
                                </Typography>
                            </TableCell>
                            <TableCell align="center">
                                <Typography sx={{ fontSize: '1rem' }}>
                                {mapTingkat(prestasiMadrasah.tingkat)}
                                </Typography>
                            </TableCell>
                            <TableCell align="center">
                                <Typography sx={{ fontSize: '1rem' }}>
                                {mapPeringkat(prestasiMadrasah.peringkat)}
                                </Typography>
                            </TableCell>
                            <TableCell align="center">
                                <Typography sx={{ fontSize: '1rem' }}>
                                {prestasiMadrasah.penyelenggara}
                                </Typography>
                            </TableCell>
                            <TableCell align="center">
                                <Typography sx={{ fontSize: '1rem' }}>
                                {prestasiMadrasah.tanggal_pencapaian}
                                </Typography>
                            </TableCell>
                            <TableCell>
                                <Box
                                ...
                                <Tooltip title="Edit" placement="bottom">
                                    <IconButton onClick={() => handleEdit(prestasiMadrasah.id)}>
                                    <IconEdit width={18} />
                                    </IconButton>
                                </Tooltip>
                                <Tooltip title="Hapus" placement="bottom">
                                    <IconButton onClick={() => handleDelete(prestasiMadrasah.id)}>
                                    <IconTrash width={18} />
                                    </IconButton>
                                </Tooltip>
                                </Box>
