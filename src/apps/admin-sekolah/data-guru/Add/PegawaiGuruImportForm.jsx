...
const PegawaiGuruImportForm = ({ setSuccess, setError }) => {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      if (data.gagal === 0) {
        setSuccess(data.msg || `Semua ${data.berhasil} data guru berhasil diimport`);
        ...
        >
          <Box>
            <Typography variant="body2" color="text.secondary">
              ...
              <strong>nama kategori Guru</strong> yang tersedia, lalu upload di langkah 2.
            </Typography>
        ...
        <Box sx={{ mb: 3 }}>
          ...
          >
            <Typography variant="body2" fontWeight={600}>
              {importResult.gagal === 0
                ? `Semua ${importResult.berhasil} data guru berhasil diimport`
                : importResult.berhasil === 0
...
export default PegawaiGuruImportForm;
