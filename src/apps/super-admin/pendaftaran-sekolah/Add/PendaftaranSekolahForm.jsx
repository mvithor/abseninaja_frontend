...
// ---------------------------------------------------------------------------
// Konstanta timezone — satu sumber kebenaran, konsisten dengan BE (VALID_TIMEZONES)
// Urutan: barat ke timur, sesuai urutan geografis Indonesia
// ---------------------------------------------------------------------------
const TIMEZONE_OPTIONS = [
  {
    value: 'Asia/Jakarta',
    label: 'WIB — Waktu Indonesia Barat',
    sublabel: 'Jawa, Sumatera, Kalimantan Barat & Tengah',
    offset: 'UTC+7',
  },
  {
    value: 'Asia/Makassar',
    label: 'WITA — Waktu Indonesia Tengah',
    sublabel: 'Sulawesi, Bali, NTB, NTT, Kalimantan Timur & Selatan',
    offset: 'UTC+8',
  },
  {
    value: 'Asia/Jayapura',
    label: 'WIT — Waktu Indonesia Timur',
    sublabel: 'Maluku, Papua',
    offset: 'UTC+9',
  },
];
...
const PendaftaranSekolahForm = ({ setSuccess, setError }) => {
  ...
  const mutation = useMutation({
    ...
    onError: (error) => {
      ...
      const errorMsg = error.response?.data?.msg || 'Terjadi kesalahan saat menambahkan data';
  ...
  const selectedTimezone = TIMEZONE_OPTIONS.find(
    (tz) => tz.value === formState.timezone_sekolah,
  );

  return (
    <Box component="form" onSubmit={handleSubmit}>
      <Box sx={{ borderRadius: 2 }}>
        <Typography variant="h6">Detail Pendaftar</Typography>
        ...
        <Grid container spacing={2} rowSpacing={1}>
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <CustomFormLabel htmlFor="kepala_sekolah" sx={{ mt: 1.85 }}>
              Kepala Sekolah
            </CustomFormLabel>
            <CustomOutlinedInput
              id="kepala_sekolah"
      ...
      <Box>
        <Typography variant="h6">Informasi Sekolah</Typography>
        ...
        <Grid container spacing={2} rowSpacing={1}>
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <CustomFormLabel htmlFor="npsn" sx={{ mt: 1.85 }}>
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <CustomFormLabel htmlFor="timezone_sekolah" sx={{ mt: 1.85 }}>
              Zona Waktu Sekolah
            </CustomFormLabel>
            ...
            <FormControl fullWidth>
              <Select
                id="timezone_sekolah"
                name="timezone_sekolah"
                value={formState.timezone_sekolah}
                onChange={handleChange}
                displayEmpty
                startAdornment={
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <CustomFormLabel htmlFor="jumlah_siswa" sx={{ mt: 1.85 }}>Jumlah Siswa</CustomFormLabel>
            <CustomOutlinedInput
              id="jumlah_siswa"
              name="jumlah_siswa"
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <CustomFormLabel htmlFor="jumlah_guru" sx={{ mt: 1.85 }}>Jumlah Guru</CustomFormLabel>
            <CustomOutlinedInput
              id="jumlah_guru"
              name="jumlah_guru"
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <CustomFormLabel htmlFor="jumlah_staf" sx={{ mt: 1.85 }}>Jumlah Staff</CustomFormLabel>
            <CustomOutlinedInput
              id="jumlah_staf"
              name="jumlah_staf"
